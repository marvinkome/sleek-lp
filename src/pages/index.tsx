        ...
        <Stack align="center" justify="center">
          <Stack align="center" px={{ base: "4", md: "18rem" }} spacing="8">
            ...
            <Text
              ...
              opacity="0.87"
            >
              Sleek offers unified APIs and tools that instantly enable developers and businesses to accept and process crypto payments
              globally.
            </Text>
          </Stack>
          <Stack
      ...
      <Container maxW="100%" h="100%" id="content">
        ...
        >
          ...
          <Stack flex="1" userSelect="none" pointerEvents="none" maxW="100%" height="100%">
            <Image src="/pay-crypto.png" alt="Sleek pay crypto form" boxSize="100%" />
          </Stack>
        </Stack>
          ...
          <Stack direction={{ base: "column", md: "row" }} px={{ base: "0", md: "12rem" }} spacing={{ base: "8", md: "12" }}>
            <Stack display={{ base: "none", md: "block" }} spacing="22rem" direction="row" pos="absolute" mt="-28rem" zIndex="-2">
              <Stack>
                ...
                <Icon viewBox="0 0 1 377" w="0.5" h="105rem" mt="-24rem" position="absolute">
                  <line
                    x1="0.4"
                    y1="-1.74846e-08"
                    x2="0.400016"
            ...
            <Stack flex="1" spacing="4" pt="12">
              <Heading color="#536BEC" fontSize={{ base: "32px", md: "64px" }} lineHeight={{ base: "48px", md: "88px" }}>
                Crypto Payment
                <Flex color="rgba(83, 107, 236, 0.36)">infrastructure for Everyone</Flex>
              </Heading>
              <Text
                w={{ base: "100%", md: "600px" }}
                fontSize={{ base: "1rem", md: "1.125rem" }}
              ...
              >
                {!submitted ? (
                  <>
                    ...
                    <FormGroup id="email">
                      <Input w={{ base: "100%", md: "24rem" }} id="email" type="email" placeholder="Email" variant="flushed" isRequired />
                    </FormGroup>
                    <FormGroup id="name">
                      <Input id="name" type="text" placeholder="Full name" variant="flushed" isRequired />
                    </FormGroup>
                    <FormGroup id="organization">
                      <Input id="organization" type="text" placeholder="Organization" variant="flushed" isRequired />
                    </FormGroup>
                  ...
                  <Text w={{ base: "100%", md: "24rem" }} textAlign="center">
                    Your details is recorded <br /> Look out for your email when we send out an invite. Thank you.
                  </Text>
                )}
              </Stack>
            </Stack>

            <Stack flex="1" spacing={{ base: "4", md: "8" }} py={{ base: "4", md: "0" }} zIndex="2">
              <Heading color="#0F0F0F" mt="-16" fontSize={{ base: "32px", md: "64px" }}>
                Sign Up!
              </Heading>
              <Text w={{ base: "100%", md: "600px" }} fontSize={{ base: "1rem", md: "1.125rem" }} pb="2">
